...
import { ENINMAN_edit, ENINMAN_edit_resp } from "@/pages/dashboard/Plantillas";
export default function ENINMAN_resp({
  id_pregunta,
  buscar,
  id_nivel,
  AbrirPreguntas,
    ...
    <Card className="w-auto mx-auto rounded-none">
      ...
      <Dialog open={openNew} handler={hanldeOpen}>
        <DialogBody className="w-full">
          ...
          <Typography className="pt-7  text-center" variant="h7" color="blue-gray">
            Agregar un espacio para escribir la respuesta el cual esta representado por NaN
          </Typography>
